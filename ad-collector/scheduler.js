...
// 네이버 타임보드(PC)/스페셜DA(모바일) 캡처: 매 정시 + 5분. 상품소개서 확인 결과(2026-08-13)
// 둘 다 1시간 단위 판매(새벽 00-08시만 4시간 단위)라 정시 기준으로 찍으면 슬롯을 안 놓치는데,
// 정각 딱 그 순간엔 이전 시간대 광고가 아직 안 내려갔거나 로테이션이 살짝 늦게 반영될 위험이
// 있어서(2026-08-18 사용자 피드백) 5분 늦춰서 전환이 확실히 끝난 뒤 캡처한다.
